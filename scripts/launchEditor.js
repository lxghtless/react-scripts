...
function guessEditor() {
	...
	try {
		if (process.platform === 'darwin') {
			...
			const output = execSync('ps x --no-heading -o comm --sort=comm')
				.toString();
